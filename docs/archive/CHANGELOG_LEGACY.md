# Legacy Changelog (Pre-Rebrand)

This file contains the changelog history from before the rebrand to Sven (v0.1.0).

These versions used the `svn.*` command/settings prefix and were published as `svn-scm`.
