...
import { OpenChange } from "./commands/openChange";
...
export function registerCommands(
  ...
  disposables.push(new OpenChange("svn.openChangeBase", "BASE"));
  ...
  disposables.push(new OpenChange("svn.openChangePrev", "PREV"));
  ...
  disposables.push(new OpenChange("svn.openChangeHead", "HEAD"));
